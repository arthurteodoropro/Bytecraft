...
import successSound from "../assets/sounds/right_answer.mp3";
import errorSound from "../assets/sounds/wrong_answer.mp3";
import winnerSound from "../assets/sounds/winner_game.mp3";
